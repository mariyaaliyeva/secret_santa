//
//  SuccessCreateGameViewController.swift
//  secret_santa
//
...
final class SuccessCreateGameViewController: UIViewController {
	...
	private lazy var button: CustomButton = {
		...
		button.titleText = "Добавить участников"
		button.addTarget(self, action: #selector(addPeopleAction), for: .touchUpInside)
		return button
	}()
